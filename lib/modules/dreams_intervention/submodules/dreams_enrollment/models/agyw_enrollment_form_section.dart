          ...
          inputFields: [
            InputField(
                ...
                options: [
                  ...
                  InputFieldOption(code: 'Sibling', name: 'Sibling'),
                  InputFieldOption(
                      code: 'Uncle or Aunt', name: 'Uncle or Aunt'),
            ...
            InputField(
                ...
                options: [
                  ...
                  InputFieldOption(
                      code: 'Ceramic tiles', name: 'Ceramic tiles'),
            ...
            InputField(
                ...
                options: [
                  ...
                  InputFieldOption(
                      code: 'Stone with mud', name: 'Stone with mud'),
                  InputFieldOption(
          ...
          inputFields: [
            ...
            InputField(
                ...
                options: [
                  ...
                  InputFieldOption(
                      code: 'Tertiary level', name: 'Tertiary level'),
                  InputFieldOption(
            ...
            InputField(
                ...
                options: [
                  ...
                  InputFieldOption(
                      code: 'Peer pressure', name: 'Peer pressure'),
                  InputFieldOption(
                      code: 'Not interested', name: 'Not interested'),
                  InputFieldOption(
            ...
            InputField(
                ...
                options: [
                  ...
                  InputFieldOption(
                      code: 'CXwRMbOl4s8', name: 'Start a business'),
                  InputFieldOption(
                      code: 'b1kQ78GvzNv', name: 'Go back to school'),
            ...
            InputField(
                ...
                options: [
                  ...
                  InputFieldOption(
                      code: 'Casual labour', name: 'Casual labour'),
                  InputFieldOption(
          ...
          inputFields: [
            ...
            InputField(
                ...
                options: [
                  ...
                  InputFieldOption(
                      code: 'eHUHUbqwtmc', name: 'Can’t afford it'),
                  InputFieldOption(
                      code: 'Obxp92Sd0Eo',
                  ...
                  InputFieldOption(
                      code: 'Vk8oBO8z3yD',
                      name:
                          'Afraid others will know about the test/ test results'),
                  InputFieldOption(
                      code: 'hOmGc8b4FRA',
          ...
          inputFields: [
            ...
            InputField(
                ...
                options: [
                  ...
                  InputFieldOption(
                      code: 'ydSybWoOk93', name: 'Religious leader'),
                  InputFieldOption(
            ...
            InputField(
                ...
                options: [
                  ...
                  InputFieldOption(
                      code: 'JWuFSdMrZXy', name: 'Religious leader'),
                  InputFieldOption(
