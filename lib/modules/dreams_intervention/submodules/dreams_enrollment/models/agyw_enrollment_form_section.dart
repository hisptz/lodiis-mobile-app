  ...
  static List<FormSection> getFormSections() {
    return [
          ...
          inputFields: [
                  ...
                  InputField(
                      ...
                      options: [
                        ...
                        InputFieldOption(code: 'XR1QhO62Zm9', name: 'Permanent (Tubal Ligation)')
                      ]), 
                     InputField(
                      id: 'qjFPwTWaHhx',
                 ...
                 InputField(
                      id: 'qdK24nEkW3f',
                      name: 'Are you currently using Injections family planning method?',
                      valueType: 'BOOLEAN',
                      inputColor: Color(0xFF258DCC),
                      labelColor: Color(0xFF05131B)),
                 InputField(
                 ...
                 InputField(
                      id: 'sKIywDycbit',
                      name: 'Are you currently using IUCD (Coil) family planning method?',
                      valueType: 'BOOLEAN',
                      inputColor: Color(0xFF258DCC),
                      labelColor: Color(0xFF05131B)),
                 InputField(
                 ...
                 InputField(
                      id: 'yButAy4UMTY',
                      name: 'Are you currently using Permanent (Tubal Ligation) family planning method?',
                      valueType: 'BOOLEAN',
                      inputColor: Color(0xFF258DCC),
                      labelColor: Color(0xFF05131B)),
                 InputField(
                 ...
                 InputField(
                      id: 'HyT7FrFWRyH',
                      name: 'What’s the main reason for not using any family planning method?',
                      valueType: 'TEXT',
                      inputColor: Color(0xFF258DCC),
                      labelColor: Color(0xFF05131B)),
                 InputField(
                      id: 'pq5LEMAI1EX',
                      name: 'Specify other reasons for not using family planning methods',
                      valueType: 'TEXT',
                      inputColor: Color(0xFF258DCC),
                      labelColor: Color(0xFF05131B)),
            ]),
          ...
          inputFields: [
                  InputField(
                      id: 'i32OwNqUYRn',
                      name: 'Has any man ever said or did something to humiliate you in front of others?',
                      valueType: 'BOOLEAN',
                      inputColor: Color(0xFF258DCC),
                      labelColor: Color(0xFF05131B)),
                InputField(
                      id: 'ClDEtAAqDPI',
                      name: 'Last three months any man said or did something to humiliate you in front of other?',
                      valueType: 'TEXT',
                      inputColor: Color(0xFF258DCC),
                      labelColor: Color(0xFF05131B),
                      options: [
                        InputFieldOption(code: 'Often', name: 'Often'),
                        InputFieldOption(code: 'sometimes', name: 'Sometimes'),
                        InputFieldOption(code: 'Not in the last 3 months', name: 'Not in the last 3 months')
                      ]),
                 InputField(
                      id: 'NgIDtgfZMVH',
                      name: 'Has any man threatened to hurt or harm you or someone you care about?',
                      valueType: 'BOOLEAN',
                      inputColor: Color(0xFF258DCC),
                      labelColor: Color(0xFF05131B)),
                InputField(
                      id: 'gY0nOLnR3eh',
                      name: 'Last three months any man threatened to hurt or harm you or someone you care about?',
                      valueType: 'TEXT',
                      inputColor: Color(0xFF258DCC),
                      labelColor: Color(0xFF05131B),
                      options: [
                ...
                InputField(
                      id: 'OZqIvrzGBFK',
                      name: 'Last three months any man insulted or made you feel bad about yourself?',
                      valueType: 'TEXT',
                      inputColor: Color(0xFF258DCC),
                      labelColor: Color(0xFF05131B),
                      options: [
                ...
                InputField(
                      id: 'iLX2uQ4ZXM0',
                      name: 'Last three months any man threatened to take away your economic livelihood?',
                      valueType: 'TEXT',
                      inputColor: Color(0xFF258DCC),
                      labelColor: Color(0xFF05131B),
                      options: [
                  ...
                  InputField(
                      id: 'NOJbkKuHccD',
                      name: 'Any man push you, shake you, slap/punch/beat you, hit you with something, try to choke you or throw something at you that could hurt you?',
                      valueType: 'BOOLEAN',
                      inputColor: Color(0xFF258DCC),
                      labelColor: Color(0xFF05131B)),
                InputField(
                      id: 'GdsRvY5lHCU',
                      name: 'Last three months any man push you, shake you, slap/punch/beat you, hit you with something, try to choke you or throw something at you that could hurt you?',
                      valueType: 'TEXT',
                      inputColor: Color(0xFF258DCC),
                      labelColor: Color(0xFF05131B),
                      options: [
                  ...
                  InputField(
                      id: 'mvPAYFoFQcW',
                      name: 'Any man physically forced you to have sexual intercourse with him when you did not want to?',
                      valueType: 'BOOLEAN',
                      inputColor: Color(0xFF258DCC),
                      labelColor: Color(0xFF05131B)),
                InputField(
                      id: 'RO2RIidPOqK',
                      name: 'Last three months any man physically forced you to have sexual intercourse with him when you did not want to?',
                      valueType: 'TEXT',
                      inputColor: Color(0xFF258DCC),
                      labelColor: Color(0xFF05131B),
                      options: [
                  ...
                  InputField(
                      id: 'WwTI82dbYIc',
                      name: 'Any man physically forced you to perform any other sexual acts you did not want to?',
                      valueType: 'BOOLEAN',
                      inputColor: Color(0xFF258DCC),
                      labelColor: Color(0xFF05131B)),
                InputField(
                      id: 'CU4HyDp6XO0',
                      name: 'Last three months any man physically forced you to perform any other sexual acts you did not want to?',
                      valueType: 'TEXT',
                      inputColor: Color(0xFF258DCC),
                      labelColor: Color(0xFF05131B),
                      options: [
                  ...
                  InputField(
                      id: 'bBVCUqsdfL3',
                      name: 'Any man force you with threats or in any other way to perform sexual acts you did not want to?',
                      valueType: 'BOOLEAN',
                      inputColor: Color(0xFF258DCC),
                      labelColor: Color(0xFF05131B)),
                InputField(
                      id: 'NP7LbypO3li',
                      name: 'Last three months any man force you with threats or in any other way to perform sexual acts you did not want to?',
                      valueType: 'TEXT',
                      inputColor: Color(0xFF258DCC),
                      labelColor: Color(0xFF05131B),
                      options: [
                ...
                InputField(
                      id: 'ZcfLYz7JlVo',
                      name: 'Did you seek help after experiencing the different things we have discussed?',
                      valueType: 'BOOLEAN',
                      inputColor: Color(0xFF258DCC),
                      labelColor: Color(0xFF05131B)),
                InputField(
                      ...
                      options: [
                        ...
                        InputFieldOption(code: 'ABZxvJiwxzk', name: 'Husband/Partner/Boyfriend’s family'),
                        ...
                        InputFieldOption(code: 'U5MaBVRWZTu', name: 'Doctor/Medical personnel'),
                        InputFieldOption(code: 'fq9YW2mfHhx', name: 'Chief or village elder'),
                ...
                InputField(
                      id: 'H2Az2c3MeAy',
                      name: 'Do you know where to seek help if you experience the different things that we discussed?',
                      valueType: 'BOOLEAN',
                      inputColor: Color(0xFF258DCC),
                      labelColor: Color(0xFF05131B)),
                InputField(
                      id: '',
                      name: 'If experienced the different things that we discussed,where would you seek help from?',
                      valueType: 'CHECK_BOX',
                      inputColor: Color(0xFF258DCC),
                      labelColor: Color(0xFF05131B),
                      options: [
                        InputFieldOption(code: 'GUOZrOkgtxO', name: 'Family'),
                        InputFieldOption(code: 'dXKzcRop0YS', name: 'Husband/Partner/Boyfriend’s family'),
                        ...
                        InputFieldOption(code: 'oWcT4kzD78y', name: 'Doctor/Medical personnel'),
                        InputFieldOption(code: 'zhumM3lBA8J', name: 'Chief or Village elder'),
         ...
         FormSection(
          ...
          inputFields: [
                ...
                InputField(
                      id: 'JSBixuSLIC5',
                      name: 'In the past 12 months, how often did you have a drink containing alcohol?',
                      valueType: 'TEXT',
                      inputColor: Color(0xFF258DCC),
                      labelColor: Color(0xFF05131B),
                      options: [
                        InputFieldOption(code: 'Everyday', name: 'Everyday'),
                        InputFieldOption(code: '5 to 6 times a week', name: '5 to 6 times a week'),
                        InputFieldOption(code: '3 to 4 times a week', name: '3 to 4 times a week'),
                        InputFieldOption(code: 'Once a week', name: 'Once a week'),
                        InputFieldOption(code: '2 to 3 times a month', name: '2 to 3 times a month'),
                        InputFieldOption(code: 'Once a month', name: 'Once a month'),
                        InputFieldOption(code: '3 to 11 times in the past year', name: '3 to 11 times in the past year'),
                        InputFieldOption(code: '1 or 2 times in the past year', name: '1 or 2 times in the past year')
                      ]),
                  InputField(
                      id: 'o9tReELSzRN',
                      name: 'Have you used drugs of abuse or addiction in the last 12 months?',
                      valueType: 'BOOLEAN',
                      inputColor: Color(0xFF258DCC),
                      labelColor: Color(0xFF05131B)),
                  InputField(
                      id: 'wfb1pQ1odtz',
                      name: 'Which type of drugs of abuse/addiction have you used in the last 12 months?',
                      valueType: 'TEXT',
                      inputColor: Color(0xFF258DCC),
                      labelColor: Color(0xFF05131B),
                      options: [
                        InputFieldOption(code: 'Marijoana or Matekoane', name: 'Marijoana or Matekoane'),
                        InputFieldOption(code: 'Glue or Petrol or Gundi', name: 'Glue or Petrol or Gundi'),
                        ...
                        InputFieldOption(code: 'Cigarettes or Tobacco', name: 'Cigarettes or Tobacco'),
                        InputFieldOption(code: 'Other', name: 'Other')
                      ]),
                  InputField(
                      id: 'YSAyCyGWCaK',
                      name: 'In the last 12 months have you engaged in brewing or selling alcohol and/or drugs of abuse or addiction?',
                      valueType: 'BOOLEAN',
                      inputColor: Color(0xFF258DCC),
                      labelColor: Color(0xFF05131B)),
                ]),
          ...
          inputFields: [
                  InputField(
                      id: 'Hn0P1sGIKe1',
                      name: 'Have you ever participated or been trained in Go Girls: Sepheo Adopted Curriculum: Married Women?',
                      valueType: 'TRUE_ONLY',
                      inputColor: Color(0xFF258DCC),
                      labelColor: Color(0xFF05131B)),
             InputField(
                      id: 'SaAW6b6glDZ',
                      name: 'Have you ever participated or been trained in Singing to the Lions: A Facilitator\'s Guide to Overcoming Fear and Violence in Our Lives?',
                      valueType: 'TRUE_ONLY',
                      inputColor: Color(0xFF258DCC),
                      labelColor: Color(0xFF05131B)),
                InputField(
                      id: 'hGzsAgaBPSY',
                      name: 'Have you ever participated or been trained in Aflatoun Non Formal Education?',
                      valueType: 'TRUE_ONLY',
                      inputColor: Color(0xFF258DCC),
                      labelColor: Color(0xFF05131B)),
                InputField(
                      id: 'iFFZOpnvyDp',
                      name: 'Have you ever participated or been trained in  Financial Education?',
                      valueType: 'TRUE_ONLY',
                      inputColor: Color(0xFF258DCC),
                      labelColor: Color(0xFF05131B)),
                InputField(
                      id: 'Ue7KBKNtUzO',
                      name: 'Have you ever participated or been trained in Savings and Internal Lending Communities (SILC)?',
                      valueType: 'TRUE_ONLY',
                      inputColor: Color(0xFF258DCC),
                      labelColor: Color(0xFF05131B)),
              InputField(
                      id: 'uEl5YpDbqnb',
                      name: 'Have you ever participated or been trained in Condom Social Marketing CSM Toolkit (Pusha love)?',
                      valueType: 'TRUE_ONLY',
                      inputColor: Color(0xFF258DCC),
                      labelColor: Color(0xFF05131B)),
                InputField(
