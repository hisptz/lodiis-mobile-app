...
import 'package:kb_mobile_app/modules/dreams_intervention/services/agyw_dreams_enrollment_none_participation_service.dart';
...
class AgywEnrollmentNoneParticipationForm extends StatefulWidget {
  ...
  @override
  State<AgywEnrollmentNoneParticipationForm> createState() =>
      _AgywEnrollmentNoneParticipationFormState();
}

class _AgywEnrollmentNoneParticipationFormState
    extends State<AgywEnrollmentNoneParticipationForm> {
  ...
  void initState() {
    ...
    setState(() {
      ...
      formSections = AgywEnrollmentNoneParticipation.getFormSections();
      isFormReady = true;
    });
  }
