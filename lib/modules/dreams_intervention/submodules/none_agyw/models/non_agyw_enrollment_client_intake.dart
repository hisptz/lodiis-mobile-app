          ...
          inputFields: [
            ...
            InputField(
                ...
                options: [
                  ...
                  InputFieldOption(
                      code: 'mhCDr6kR2Kd', name: 'Farmer/Farm worker'),
                  InputFieldOption(
                  ...
                  InputFieldOption(
                      code: 'IE87JCiIBa7', name: 'Informal Trader'),
                  InputFieldOption(
                      code: 'jrv5kdmkcuk', name: 'Military/Uniformed'),
                  InputFieldOption(
            ...
            InputField(
                ...
                options: [
                  ...
                  InputFieldOption(
                      code: 'Less than Standard 7',
                      name: 'Less than Standard 7'),
                  InputFieldOption(
            ...
            InputField(
                ...
                options: [
                  ...
                  InputFieldOption(
                      code: 'EVWGGunQ349', name: 'My Partner died'),
                  InputFieldOption(
                      code: 'ity7CyZHyqE',
                  ...
                  InputFieldOption(
                      code: 'Wfnk8y9jxPA', name: 'My Partner is sick'),
                  InputFieldOption(
                      code: 'jq8Lwo7mmKB',
            ...
            InputField(
                ...
                options: [
                  ...
                  InputFieldOption(
                      code: 'AdmjXPgHtjt', name: 'Other HTC client'),
            ...
            InputField(
                ...
                options: [
                  ...
                  InputFieldOption(
                      code: 'Mu9huWfFi6X',
                      name: 'Rreduce risk through abstinence'),
                  InputFieldOption(
                      code: 't3jLGKYPh8P',
