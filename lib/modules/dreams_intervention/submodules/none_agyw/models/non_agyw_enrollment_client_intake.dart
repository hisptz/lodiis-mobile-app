    ...
    return [
          ...
          inputFields: [
                  ...
                  InputField(
                      ...
                      labelColor: Color(0xFF05131B),
                     options: [
                        InputFieldOption(code: 'CounselingTesting', name: 'Counseling Testing'),
                 ...
                 InputField(
                  ...
                  InputField(
                      id: 'IzpeMJCYdY3',
                      name: 'Are you or your partner planning to have a child within next 2 years?',
                      valueType: 'BOOLEAN',
                      inputColor: Color(0xFF258DCC),
                      labelColor: Color(0xFF05131B)),
                   InputField(
                      ...
                      options: [
                        ...
                        InputFieldOption(code: 'g91sLXH63DS', name: 'Domestic worker/gardener'),
                        ...
                        InputFieldOption(code: 'a6zQBSLXblz', name: 'Trucker/Truck driver'),
                        InputFieldOption(code: 'mkxVfNhSflG', name: 'Commercial Sex Worker'),
                  ...
                  InputField(
                      ...
                      options: [
                        ...
                        InputFieldOption(code: 'College CertificateDiploma', name: 'College CertificateDiploma'),
                        InputFieldOption(code: 'University Degree', name: 'University Degree'),
                        InputFieldOption(code: 'Graduate DegreeMastersPhD', name: 'Graduate DegreeMastersPhD')
                      ]),
                 InputField(
                      id: '',
                      ...
                      labelColor: Color(0xFF05131B),
                      options: [
                        InputFieldOption(code: 'UHVI3qHmuE8', name: 'I Have multiple partners'),
                        InputFieldOption(code: 'Vb6PnBKyTMo', name: 'I Have a child who is sick or died'),
                        InputFieldOption(code: 'EVWGGunQ349', name: 'My Partner died'),
                        InputFieldOption(code: 'ity7CyZHyqE', name: 'I Worried about my past behaviour/curious'),
                        InputFieldOption(code: 'aayhISGUuut', name: 'I Worried abut my partner’s behaviour/status'),
                        InputFieldOption(code: 'Wfnk8y9jxPA', name: 'My Partner is sick'),
                        InputFieldOption(code: 'jq8Lwo7mmKB', name: 'My Partner has tested positive for HIV'),
                        InputFieldOption(code: 'aidssV5DBCX', name: 'I am feeling unwell'),
                        InputFieldOption(code: 'IVNtCt94hcn', name: 'I was Advised by my family/friends'),
                        InputFieldOption(code: 'GSCvB7kMXsj', name: 'I was Advised by health care worker'),
                        InputFieldOption(code: 'kSHcQ7GMTyz', name: 'I am Planning to get married'),
                        InputFieldOption(code: 'e1vmWq3vRLw', name: 'I am Getting serious/stopping condoms'),
                        InputFieldOption(code: 'RszIBO0MV2L', name: 'I am Planning to have a baby'),
                        InputFieldOption(code: 'yDH9g8RgVF1', name: 'I am pregnant'),
                        InputFieldOption(code: 'YdmwV9DYKBw', name: 'My Partner requested'),
                        InputFieldOption(code: 'bG00RdeHbzZ', name: 'For life insurance'),
                        InputFieldOption(code: 'IvfnumFvkm5', name: 'For scholarship/studies'),
                        InputFieldOption(code: 'ciN6EvS4g1e', name: 'For travel/visa'),
                        InputFieldOption(code: 'hwDtsqQZniS', name: 'I am Retesting (Closing the window)'),
                        InputFieldOption(code: 'hfRfomMbY6s', name: 'I am Retesting (Confirmation of HIV positive)'),
                 ...
                 InputField(
                  ...
                  InputField(
                      ...
                      options: [
                        ...
                        InputFieldOption(code: 'gj949am6Rbq', name: 'Other Family Member'),
                        ...
                        InputFieldOption(code: 'ZfmlC3z2UFu', name: 'Newspaper advert or article'),
                ...
                InputField(
                      id: 'MabTaKRVTk6',
                      name: 'Has your most recent sex partiner been tested in the last 3 months?',
                      valueType: 'TEXT',
                      inputColor: Color(0xFF258DCC),
                      labelColor: Color(0xFF05131B),
                      options: [
                        InputFieldOption(code: 'Yes,result was negative 4', name: 'Yes,result was negative 4'),
                        InputFieldOption(code: 'Yes,result was positive 5', name: 'Yes,result was positive 5'),
                        InputFieldOption(code: 'Yes,but I don’t know the result 6', name: 'Yes,but I don’t know the result 6')
                      ]),
                InputField(
                      id: 'U90wPGZgftv',
                ...
                InputField(
                 ...
                 InputField(
                      id: 'ABXLlTiHysm',
                      name: 'In last 12 months have you exchanged money/material for sex?',
                      valueType: 'BOOLEAN',
                      inputColor: Color(0xFF258DCC),
                      labelColor: Color(0xFF05131B)),
                 InputField(
                      id: 'zkbozPIE3Zh',
                      name: 'In last 12 month have you had unprotected sexual intercourse?',
                      valueType: 'BOOLEAN',
                      inputColor: Color(0xFF258DCC),
                      labelColor: Color(0xFF05131B)),
                 InputField(
                 ...
                 InputField(
                      id: 'oDnqGLMuwgo',
                      name: 'In last 12 months have you had shared needles for injections?',
                      valueType: 'BOOLEAN',
                      inputColor: Color(0xFF258DCC),
                      labelColor: Color(0xFF05131B)),
                InputField(
                      id: 'wI9gNztaVzD',
                      name: 'Have you had genital sores or unusual leakage within the past 12 months?',
                      valueType: 'TEXT',
                      inputColor: Color(0xFF258DCC),
                      labelColor: Color(0xFF05131B),
                      options: [
                ...
                InputField(
                 ...
                 InputField(
                      id: 'h5llEgMRPEy',
                      name: 'How many sexual partners(including your spouse)have you had sex with in the last 12 months?',
                      valueType: 'NUMBER',
                      inputColor: Color(0xFF258DCC),
                      labelColor: Color(0xFF05131B)),
                InputField(
                      id: 'N505gDx35lK',
                      name: 'Do you currently have more than one sexual partner(including your spouse)?',
                      valueType: 'TEXT',
                      inputColor: Color(0xFF258DCC),
                      labelColor: Color(0xFF05131B),
                      options: [
                 ...
                 InputField(
                      id: 'irTgmXk3Lo8',
                      name: 'The last time you had sex with a non-regular partner,did you use a condom?',
                      valueType: 'TEXT',
                      inputColor: Color(0xFF258DCC),
                      labelColor: Color(0xFF05131B),
                      options: [
                   ...
                   InputField(
                      id: 'bgigq6VXGlz',
                      name: 'The last time you had sex with a regular partner, did you use a condom?',
                      valueType: 'TEXT',
                      inputColor: Color(0xFF258DCC),
                      labelColor: Color(0xFF05131B),
                      options: [
                ...
                InputField(
                  ...
                  InputField(
                   ...
                   InputField(
                      ...
                      labelColor: Color(0xFF05131B),
                      options: [
                        InputFieldOption(code: 'tTmeXXmDO4S', name: 'Reduce risk through use of condom'),
                        InputFieldOption(code: 'povx6WxobsZ', name: 'Reduce risk through monogamy'),
                        InputFieldOption(code: 'Mu9huWfFi6X', name: 'Rreduce risk through abstinence'),
                        InputFieldOption(code: 't3jLGKYPh8P', name: 'Reduce risk through Treatment of of STIs'),
                        InputFieldOption(code: 'IZgsyl3yhGB', name: 'Reduce risk through Decreased # of partners')
                ]),
               InputField(
                      id: 'IJUy3A0IVpr',
                      name: 'Referral made?',
                ...
                InputField(
                      ...
                      options: [
                        ...
                        InputFieldOption(code: 'Family Planning', name: 'Family Planning'),
                        ...
                        InputFieldOption(code: 'PsychoSocial SupportSupport Group', name: 'PsychoSocial SupportSupport Group'),
                        InputFieldOption(code: 'Nutritional DrugAlcohol Abuse', name: 'Nutritional DrugAlcohol Abuse')
                ])
            ]),
          FormSection(
          ...
          inputFields: [
                  ...
                  InputField(
                      id: 'uvkZ4vHUzxv',
                      name: 'Sexual partner who has been on ART for more than 6 months but is not virally suppressed',
                      valueType: 'TRUE_ONLY',
                      inputColor: Color(0xFF258DCC),
                      labelColor: Color(0xFF05131B)),
                  InputField(
                      id: 'Se87hpRzGGB',
                      name: 'Vaginal or anal sexual intercourse without condoms with more than one partner',
                      valueType: 'TRUE_ONLY',
                      inputColor: Color(0xFF258DCC),
                      labelColor: Color(0xFF05131B)),
                  InputField(
                  ...
                  InputField(
                      id: 'q3JCqCyX4aI',
                      name: 'A history of a sexually transmitted infection(STI)by lab testing or self-report or syndromic STI treatment',
                      valueType: 'TRUE_ONLY',
                      inputColor: Color(0xFF258DCC),
                      labelColor: Color(0xFF05131B)),
                  InputField(
                      id: 'rBktFvgfp52',
                      name: 'Client has requested PrEP and has received information on PrEP including which people would benefit from PrEP and client still feels they would benefit from PrEP',
                      valueType: 'TRUE_ONLY',
                      inputColor: Color(0xFF258DCC),
                      labelColor: Color(0xFF05131B)),
          ])
