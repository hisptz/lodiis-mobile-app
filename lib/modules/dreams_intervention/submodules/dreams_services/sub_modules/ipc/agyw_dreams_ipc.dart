...
import 'package:kb_mobile_app/modules/dreams_intervention/submodules/dreams_services/sub_modules/ipc/pages/agyw_dreams_ipc_form.dart';
import 'package:kb_mobile_app/modules/ovc_intervention/components/ovc_enrollment_form_save_button.dart';
import 'package:provider/provider.dart';

class AgywDreamIPC extends StatefulWidget {
  AgywDreamIPC({Key key}) : super(key: key);

  @override
  _AgywDreamIPCState createState() => _AgywDreamIPCState();
}

class _AgywDreamIPCState extends State<AgywDreamIPC> {
  final String label = 'IPC';
  List<String> programStageids = [IPCConstant.programStage];
  @override
  void initState() {
    super.initState();
  }
  ...
  void onAddPrep(BuildContext context, AgywDream agywDream) {
    ...
    Navigator.push(
        context, MaterialPageRoute(builder: (context) => AgywDreamsIPCForm()));
  }
