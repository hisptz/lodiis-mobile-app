...
import 'package:kb_mobile_app/modules/dreams_intervention/submodules/dreams_services/sub_modules/lbse/pages/agyw_dreams_lbse_form.dart';
import 'package:kb_mobile_app/modules/ovc_intervention/components/ovc_enrollment_form_save_button.dart';
import 'package:provider/provider.dart';

class AgywDreamLBSE extends StatefulWidget {
  AgywDreamLBSE({Key key}) : super(key: key);

  @override
  _AgywDreamLBSEState createState() => _AgywDreamLBSEState();
}

class _AgywDreamLBSEState extends State<AgywDreamLBSE> {
  final String label = 'LBSE';
  List<String> programStageids = [LBSEConstant.programStage];
  @override
  void initState() {
    super.initState();
  }
  ...
  void onAddPrep(BuildContext context, AgywDream agywDream) {
    ...
    Navigator.push(context,
        MaterialPageRoute(builder: (context) => AgywDreamsLBSEForm()));
  }
