...
class BioDataIndexContactsForm extends StatelessWidget {
  const BioDataIndexContactsForm({Key key}) : super(key: key);

  final String label = 'BIO DATA: Index contacts';
  ...
  Widget build(BuildContext context) {
    final List<FormSection> enrollmentForm =
        BioDataIndexContacts.getFormSections();
    return SafeArea(
        child: Scaffold(
