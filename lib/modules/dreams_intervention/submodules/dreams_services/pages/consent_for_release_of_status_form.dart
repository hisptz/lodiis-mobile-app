...
class ConsentForReleaseOfStatusForm extends StatelessWidget {
  const ConsentForReleaseOfStatusForm({Key key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    final List<FormSection> enrollmentForm =
        ConsentForReleaseOfStatus.getFormSections();
    return SafeArea(
        child: Scaffold(
