               ...
               inputFields: [
                  ...
                  InputField(
                      ...
                      options: [
                        ...
                        InputFieldOption(code: 'Known Positive', name: 'Known Positive'),
                        InputFieldOption(code: 'Migrated', name: 'Migrated'), 
                        InputFieldOption(code: 'HH not located', name: 'HH not located'), 
                        InputFieldOption(code: 'Phone not reachable', name: 'Phone not reachable'),
                        InputFieldOption(code: 'Other', name: 'Other')
                      ]),
                   InputField(
                      id: 'dvDWG0RgGU8',
                      name: "Partner's address (including any landmarks, e.g. next to the church",
                      valueType: 'TEXT',
                      inputColor: Color(0xFF258DCC),
                      labelColor: Color(0xFF05131B)),
                   InputField(
