    ...
    return Container(
      ...
      child: Column(
        children: [ Row(
          ...
          LineSeperator(  height: 1, color: Color(0xFFECF9EB), ),
          Container( color: Color(0xFFFFFFFF),
            padding: EdgeInsets.only(bottom: 9, top: 9),
            child: Row(mainAxisAlignment: MainAxisAlignment.start,
              children: [Expanded( flex: 0,
                    child: Container(
                        margin: EdgeInsets.only(left: 4),
                        child: Row( mainAxisAlignment: MainAxisAlignment.start,
                          children: [Text( "    Sex  ",style: TextStyle(color: Color(0xFF8FAF8F)),
                            ),
                            Text("female      ",
                                style: TextStyle(color: Color(0xFF35B638)))], ))),
                Expanded( flex: 0, child: Container( child: Row(
                      mainAxisAlignment: MainAxisAlignment.start,
                      children: [
                        Text("Age  ",
