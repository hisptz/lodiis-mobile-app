...
class OvcHouseHoldCaseTransferForm extends StatefulWidget {
  const OvcHouseHoldCaseTransferForm({Key key}) : super(key: key);

  @override
  _OvcHouseHoldCaseTransferFormState createState() =>
      _OvcHouseHoldCaseTransferFormState();
}

class _OvcHouseHoldCaseTransferFormState
    extends State<OvcHouseHoldCaseTransferForm> {
