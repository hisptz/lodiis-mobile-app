            ...
            FormSection(
                ...
                inputFields: [
                    InputField(
                      ...
                      options: [
                        InputFieldOption(code: 'A current close contact of a person known or suspe', name: 'A current close contact of a person known or suspe'),
                        InputFieldOption(code: 'Is HIV positive', name: 'Is HIV positive'),
                 ...
                 InputField(
                      id: 'ItMRTuAI5EK',
                      name: 'Swelling in the neck, armpit or groin for more than 2 weeks?',
                      valueType: 'BOOLEAN',
                      inputColor: Color(0xFF4B9F46),
                      labelColor: Color(0xFF737373)),
                ])
