...
class OvcServicesHivscreeningForm extends StatefulWidget {
  const OvcServicesHivscreeningForm({Key key}) : super(key: key);

  @override
  _OvcServicesHivscreeningFormState createState() =>
      _OvcServicesHivscreeningFormState();
}

class _OvcServicesHivscreeningFormState
    extends State<OvcServicesHivscreeningForm> {
  final List<FormSection> formSections =
      OvcServicesHivscreening.getFormSections();
  final String label = 'Hiv Screening';
