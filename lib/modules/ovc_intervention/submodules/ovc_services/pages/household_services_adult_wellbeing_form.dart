...
class HouseholdServicesAdultWellbeingForm extends StatefulWidget {
  const HouseholdServicesAdultWellbeingForm({Key key}) : super(key: key);

  @override
  _HouseholdServicesAdultWellbeingFormState createState() =>
      _HouseholdServicesAdultWellbeingFormState();
}

class _HouseholdServicesAdultWellbeingFormState
    extends State<HouseholdServicesAdultWellbeingForm> {
  final List<FormSection> formSections =
      HouseholdServicesAdultWellbeing.getFormSections();
