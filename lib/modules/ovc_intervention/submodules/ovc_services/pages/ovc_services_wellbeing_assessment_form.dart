...
class OvcServicesWellbeingAssessmentForm extends StatefulWidget {
  const OvcServicesWellbeingAssessmentForm({Key key}) : super(key: key);

  @override
  _OvcServicesWellbeingAssessmentFormState createState() =>
      _OvcServicesWellbeingAssessmentFormState();
}

class _OvcServicesWellbeingAssessmentFormState
    extends State<OvcServicesWellbeingAssessmentForm> {
  final List<FormSection> formSections =
      OvcServicesWellbeingAssessment.getFormSections();
