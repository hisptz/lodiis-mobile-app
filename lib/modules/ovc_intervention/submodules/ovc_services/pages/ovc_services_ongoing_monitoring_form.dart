...
class OvcServicesOngoingMonitoringForm extends StatefulWidget {
  const OvcServicesOngoingMonitoringForm({Key key}) : super(key: key);

  @override
  _OvcServicesOngoingMonitoringFormState createState() =>
      _OvcServicesOngoingMonitoringFormState();
}

class _OvcServicesOngoingMonitoringFormState
    extends State<OvcServicesOngoingMonitoringForm> {
  final List<FormSection> formSections =
      OvcServicesOngoingMonitoring.getFormSections();
  final String label = 'Ongoing monitoring';
