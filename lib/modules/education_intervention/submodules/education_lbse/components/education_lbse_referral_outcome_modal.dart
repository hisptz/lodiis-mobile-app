...
import 'package:kb_mobile_app/modules/education_intervention/submodules/education_lbse/skip_logics/education_lbse_referral_outcome_skip_logic.dart';
import 'package:provider/provider.dart';

class EducationLbseRefferalOutcomeModal extends StatefulWidget {
  ...
  @override
  State<EducationLbseRefferalOutcomeModal> createState() =>
      _EducationLbseRefferalOutcomeModalState();
}
  ...
  evaluateSkipLogics() {
    Timer(
      ...
      () async {
        ...
        await EducationLbseReferralOutcomeSkipLogic.evaluateSkipLogics(
          context,
          widget.formSections,
          dataObject,
        );
