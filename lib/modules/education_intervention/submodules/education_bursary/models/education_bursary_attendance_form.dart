...
class EducationBursaryAttendanceForm {
  ...
  static List<FormSection> getFormSections() {
    return [
      FormSection(name: 'Attendance', color: Color(0xFF009688), inputFields: [
        InputField(
          id: 'eventDate',
          name: 'Date',
          valueType: 'DATE',
        ...
        InputField(
            ...
            options: [
              ...
              InputFieldOption(code: 'Legal service', name: 'Legal services'),
              InputFieldOption(
                  code: 'Safety and sercurity (police)',
                  name: 'Safety and sercurity (police)'),
              InputFieldOption(code: 'Psycho social', name: 'Psycho social'),
              InputFieldOption(
